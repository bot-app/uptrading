...
from uptrading.enums import CandleType, MarginMode, PriceType, TradingMode
from uptrading.exceptions import DDosProtection, OperationalException, TemporaryError
from uptrading.exchange import Exchange
from uptrading.exchange.common import retrier
from uptrading.exchange.types import OHLCVResponse, Tickers
from uptrading.misc import deep_merge_dicts, json_load
...
class Binance(Exchange):
    ...
    def funding_fee_cutoff(self, open_date: datetime):
        ...
        https://github.com/bot-app/uptrading/pull/5779#discussion_r740175931
