...
from uptrading.constants import ExchangeConfig
from uptrading.exceptions import DDosProtection, RetryableOrderError, TemporaryError
            ...
            if count > 0:
                ...
                if isinstance(ex, DDosProtection):
                    if kucoin and "429000" in str(ex):
                        ...
                        # see https://github.com/bot-app/uptrading/issues/5700 for details.
