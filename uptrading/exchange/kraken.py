...
from uptrading.enums import MarginMode, TradingMode
from uptrading.exceptions import (DDosProtection, InsufficientFundsError, InvalidOrderException,
                                  OperationalException, TemporaryError)
from uptrading.exchange import Exchange
from uptrading.exchange.common import retrier
from uptrading.exchange.exchange_utils import ROUND_DOWN, ROUND_UP
...
class Kraken(Exchange):
    ...
    def calculate_funding_fees(
        ...
        """
        # ! This method will always error when run by Uptrading because time_in_ratio is never
