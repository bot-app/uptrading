...
from uptrading.misc import round_dict
...
class IHyperOpt(ABC):
    """
    Interface for uptrading hyperopt
    ...
    def roi_space(self) -> List[Dimension]:
        ...
        It's used by Uptrading by default, if no custom roi_space method is defined.
        """
        ...
        #
        # The scaling is designed so that it maps exactly to the legacy Uptrading roi_space()
