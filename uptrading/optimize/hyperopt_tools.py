...
from uptrading.constants import FTHYPT_FILEVERSION, Config
from uptrading.enums import HyperoptState
from uptrading.exceptions import OperationalException
from uptrading.misc import deep_merge_dicts, round_coin_value, round_dict, safe_value_fallback2
from uptrading.optimize.hyperopt_epoch_filters import hyperopt_filter_epochs
from uptrading.optimize.optimize_reports import generate_wins_draws_losses
        ...
        for epochs_tmp in HyperoptTools._read_results(results_file):
            if total_epochs == 0 and epochs_tmp[0].get('is_best') is None:
                raise OperationalException(
                    ...
                    "of Uptrading and cannot be loaded.")
