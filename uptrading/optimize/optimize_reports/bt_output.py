...
from uptrading.constants import UNLIMITED_STAKE_AMOUNT, Config
from uptrading.misc import decimals_per_coin, round_coin_value
from uptrading.optimize.optimize_reports.optimize_reports import generate_periodic_breakdown_stats
from uptrading.types import BacktestResultType
...
def text_table_add_metrics(strat_results: Dict) -> str:
    if len(strat_results['trades']) > 0:
        ...
        # command stores these results and newer version of uptrading must be able to handle old
