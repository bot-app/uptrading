...
from uptrading.optimize.base_analysis import BaseAnalysis, VarHolder
...
class LookaheadAnalysis(BaseAnalysis):
    ...
    def prepare_data(self, varholder: VarHolder, pairs_to_load: List[DataFrame]):
        ...
        if 'upai' in self.local_config and 'identifier' in self.local_config['upai']:
            # purge previous data if the upai model is defined
            ...
            path_to_current_identifier = (
                Path(f"{self.local_config['user_data_dir']}/models/"
                     f"{self.local_config['upai']['identifier']}").resolve())
