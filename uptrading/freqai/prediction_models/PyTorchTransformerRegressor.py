...
from uptrading.upai.base_models.BasePyTorchRegressor import BasePyTorchRegressor
from uptrading.upai.data_kitchen import UpaiDataKitchen
from uptrading.upai.torch.PyTorchDataConvertor import (DefaultPyTorchDataConvertor,
                                                         PyTorchDataConvertor)
from uptrading.upai.torch.PyTorchModelTrainer import PyTorchTransformerTrainer
from uptrading.upai.torch.PyTorchTransformerModel import PyTorchTransformerModel


class PyTorchTransformerRegressor(BasePyTorchRegressor):
    """
    This class implements the fit method of IUpaiModel.
    ...
    parameters are passed via `model_training_parameters` under the upai
    ...
    def __init__(self, **kwargs) -> None:
        ...
        config = self.upai_info.get("model_training_parameters", {})
    ...
    def predict(
        self, unfiltered_df: pd.DataFrame, dk: UpaiDataKitchen, **kwargs
