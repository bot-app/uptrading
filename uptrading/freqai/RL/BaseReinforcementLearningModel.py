...
from uptrading.upai.RL.Base5ActionRLEnv import Actions, Base5ActionRLEnv
from uptrading.upai.RL.BaseEnvironment import BaseActions, BaseEnvironment, Positions
from uptrading.upai.tensorboard.TensorboardCallback import TensorboardCallback
...
class BaseReinforcementLearningModel(IUpaiModel):
    """
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.max_threads = min(self.upai_info['rl_config'].get(
            'cpu_count', 1), max(int(self.max_system_threads / 2), 1))
        th.set_num_threads(self.max_threads)
        self.reward_params = self.upai_info['rl_config']['model_reward_parameters']
        ...
        self.rl_config = self.upai_info['rl_config']
        ...
        self.policy_type = self.upai_info['rl_config']['policy_type']
    ...
    def unset_outlier_removal(self):
        ...
        if self.upai_info['data_split_parameters'].get('shuffle', False):
            self.upai_info['data_split_parameters'].update({'shuffle': False})
            logger.warning('User tried to shuffle training data. Setting shuffle to False')

    def train(
        self, unfiltered_df: DataFrame, pair: str, dk: UpaiDataKitchen, **kwargs
    ) -> Any:
        """
    ...
    def set_train_and_eval_environments(self, data_dictionary: Dict[str, DataFrame],
        ...
        :param dk: UpaiDataKitchen = the datakitchen for the current pair
        """
    ...
    @abstractmethod
    def fit(self, data_dictionary: Dict[str, Any], dk: UpaiDataKitchen, **kwargs):
        """
    ...
    def rl_model_predict(self, dataframe: DataFrame,
                         dk: UpaiDataKitchen, model: Any) -> DataFrame:
        """
        A helper function to make predictions in the Reinforcement learning module.
        :param dataframe: DataFrame = the dataframe of features to make the predictions on
        :param dk: UpaiDatakitchen = data kitchen for the current pair
    ...
    def build_ohlc_price_dataframes(self, data_dictionary: dict,
                                    pair: str, dk: UpaiDataKitchen) -> Tuple[DataFrame,
                                                                               DataFrame]:
        """
    ...
    def drop_ohlc_from_df(self, df: DataFrame, dk: UpaiDataKitchen):
        """
    ...
    def load_model_from_disk(self, dk: UpaiDataKitchen) -> Any:
        """
