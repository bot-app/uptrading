"""
Uptrading is the main module of this bot. It contains the class Uptrading()
"""
import logging
import traceback
...
from uptrading.configuration import validate_config_consistency
from uptrading.constants import BuySell, Config, EntryExecuteMode, ExchangeConfig, LongShort
from uptrading.data.converter import order_book_to_dataframe
from uptrading.data.dataprovider import DataProvider
from uptrading.edge import Edge
from uptrading.enums import (ExitCheckTuple, ExitType, RPCMessageType, RunMode, SignalDirection,
                             State, TradingMode)
from uptrading.exceptions import (DependencyException, ExchangeError, InsufficientFundsError,
                                  InvalidOrderException, PricingError)
from uptrading.exchange import (ROUND_DOWN, ROUND_UP, remove_exchange_credentials,
                                timeframe_to_minutes, timeframe_to_next_date, timeframe_to_seconds)
from uptrading.misc import safe_value_fallback, safe_value_fallback2
from uptrading.mixins import LoggingMixin
from uptrading.persistence import Order, PairLocks, Trade, init_db
from uptrading.persistence.key_value_store import set_startup_time
...
from uptrading.rpc import RPCManager
from uptrading.rpc.external_message_consumer import ExternalMessageConsumer
from uptrading.rpc.rpc_types import (RPCBuyMsg, RPCCancelMsg, RPCProtectionMsg, RPCSellCancelMsg,
                                     RPCSellMsg)
from uptrading.strategy.interface import IStrategy
from uptrading.strategy.strategy_wrapper import strategy_safe_wrapper
from uptrading.util import FtPrecise
from uptrading.util.binance_mig import migrate_binance_futures_names
...
class UptradingBot(LoggingMixin):
    """
    Uptrading is the main class of the bot.
    ...
    def __init__(self, config: Config) -> None:
        ...
        # initialization, even before Uptradingbot has a chance to start its throttling,
        # so anything in the Uptradingbot instance should be ready (initialized), including
    ...
    def process(self) -> None:
        ...
        # Without this, uptrading may try to recreate stoploss_on_exchange orders
    ...
    def handle_onexchange_order(self, trade: Trade):
        ...
        try:
            ...
            # catching https://github.com/bot-app/uptrading/issues/9025
