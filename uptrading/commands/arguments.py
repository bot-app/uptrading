...
from uptrading.commands.cli_options import AVAILABLE_CLI_OPTIONS
from uptrading.constants import DEFAULT_CONFIG


ARGS_COMMON = ["verbosity", "logfile", "version", "config", "datadir", "user_data_dir"]

ARGS_STRATEGY = ["strategy", "strategy_path", "recursive_strategy_search", "upaimodel",
                 "upaimodel_path"]
...
ARGS_LIST_UPAIMODELS = ["upaimodel_path", "print_one_column", "print_colorized"]
...
NO_CONF_REQURIED = ["convert-data", "convert-trade-data", "download-data", "list-timeframes",
                    "list-markets", "list-pairs", "list-strategies", "list-upaimodels",
...
class Arguments:
    ...
    def _build_subcommands(self) -> None:
        ...
        from uptrading.commands import (start_analysis_entries_exits, start_backtesting,
                                        start_backtesting_show, start_convert_data,
                                        start_convert_db, start_convert_trades,
                                        start_create_userdir, start_download_data, start_edge,
                                        start_hyperopt, start_hyperopt_list, start_hyperopt_show,
                                        start_install_ui, start_list_data, start_list_exchanges,
                                        start_list_upAi_models, start_list_markets,
        ...
        # Add list-upAi Models subcommand
        list_upaimodels_cmd = subparsers.add_parser(
            'list-upaimodels',
            help='Print available upAi models.',
            parents=[_common_parser],
        )
        list_upaimodels_cmd.set_defaults(func=start_list_upAi_models)
        self._build_args(optionlist=ARGS_LIST_UPAIMODELS, parser=list_upaimodels_cmd)
