...
from uptrading import __version__, constants
from uptrading.constants import HYPEROPT_LOSS_BUILTIN
...
AVAILABLE_CLI_OPTIONS = {
    ...
    "ui_version": Arg(
        '--ui-version',
        help=('Specify a specific version of UpUI to install. '
    ...
    "upaimodel": Arg(
        '--upaimodel',
        help='Specify a custom upaimodels.',
        metavar='NAME',
    ),
    "upaimodel_path": Arg(
        '--upaimodel-path',
        help='Specify additional lookup path for upaimodels.',
        metavar='PATH',
    ),
    "upai_backtest_live_models": Arg(
