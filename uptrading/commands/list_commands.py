...
from uptrading.exchange import list_available_exchanges, market_is_active
from uptrading.misc import parse_db_uri_for_logging, plural
from uptrading.resolvers import ExchangeResolver, StrategyResolver
from uptrading.types import ValidExchangesType
...
def start_list_exchanges(args: Dict[str, Any]) -> None:
    ...
    if args['print_one_column']:
        ...
        if args['list_exchanges_all']:
            ...
            print("Exchanges available for Uptrading:")
...
def start_list_upAi_models(args: Dict[str, Any]) -> None:
    """
    Print files with UpAi models custom classes available in the directory
    """
    config = setup_utils_configuration(args, RunMode.UTIL_NO_EXCHANGE)
    from uptrading.resolvers.upaimodel_resolver import UpaiModelResolver
    model_objs = UpaiModelResolver.search_all_objects(config, not args['print_one_column'])
    # Sort alphabetically
