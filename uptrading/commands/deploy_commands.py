...
from uptrading.configuration.directory_operations import copy_sample_files, create_userdata_dir
from uptrading.constants import USERPATH_STRATEGIES
from uptrading.enums import RunMode
from uptrading.exceptions import OperationalException
from uptrading.util import render_template, render_template_with_fallback
...
def get_ui_download_url(version: Optional[str] = None) -> Tuple[str, str]:
    base_url = 'https://api.github.com/repos/bot-app/frequi/'
...
def start_install_ui(args: Dict[str, Any]) -> None:
    ...
    if curr_version == latest_version and not args.get('erase_ui_only'):
        logger.info(f"UI already up-to-date, UpUI Version {curr_version}.")
        return
