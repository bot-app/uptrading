...
from uptrading.misc import round_coin_value
...
def start_backtesting(args: Dict[str, Any]) -> None:
    ...
    logger.info('Starting uptrading in Backtesting mode')
...
def start_backtesting_show(args: Dict[str, Any]) -> None:
    ...
    from uptrading.data.btanalysis import load_backtest_stats
    from uptrading.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_hyperopt(args: Dict[str, Any]) -> None:
    ...
    logger.info('Starting uptrading in Hyperopt mode')
    ...
    try:
        ...
        logger.info("Another running instance of uptrading Hyperopt detected.")
        logger.info("Simultaneous execution of multiple Hyperopt commands is not supported. "
                    "Hyperopt module is resource hungry. Please run your Hyperopt sequentially "
                    "or on separate machines.")
        logger.info("Quitting now.")
        # TODO: return False here in order to help uptrading to exit
...
def start_edge(args: Dict[str, Any]) -> None:
    ...
    :return: None
    """
    from uptrading.optimize.edge_cli import EdgeCli

    # Initialize configuration
    config = setup_optimize_configuration(args, RunMode.EDGE)
    logger.info('Starting uptrading in Edge mode')
...
def start_lookahead_analysis(args: Dict[str, Any]) -> None:
    ...
    :return: None
    """
    from uptrading.optimize.analysis.lookahead_helpers import LookaheadAnalysisSubFunctions
...
def start_recursive_analysis(args: Dict[str, Any]) -> None:
    ...
    :return: None
    """
    from uptrading.optimize.analysis.recursive_helpers import RecursiveAnalysisSubFunctions
