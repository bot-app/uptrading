...
from uptrading.configuration.directory_operations import chown_user_directory
from uptrading.constants import UNLIMITED_STAKE_AMOUNT
from uptrading.exceptions import OperationalException
from uptrading.exchange import MAP_EXCHANGE_CHILDCLASS, available_exchanges
from uptrading.util import render_template
...
def ask_user_config() -> Dict[str, Any]:
    ...
    questions: List[Dict[str, Any]] = [
        ...
        },
        {
            "type": "confirm",
            "name": "api_server",
            "message": "Do you want to enable the Rest API (includes UpUI)?",
            "default": False,
        },
        {
            "type": "text",
