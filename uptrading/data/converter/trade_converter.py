...
from uptrading.constants import (DEFAULT_DATAFRAME_COLUMNS, DEFAULT_TRADES_COLUMNS, TRADES_DTYPES,
                                 Config, TradeList)
...
def convert_trades_format(config: Config, convert_from: str, convert_to: str, erase: bool):
    ...
    if convert_from == 'kraken_csv':
        ...
        from uptrading.data.converter.trade_converter_kraken import import_kraken_trades_from_csv
