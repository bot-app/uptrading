...
from uptrading.constants import DATETIME_PRINT_FORMAT, IntOrInf
from uptrading.enums import MarginMode, OrderTypeValues, SignalDirection, TradingMode
...
class UpAiModelListResponse(BaseModel):
    upaimodels: List[str]
...
class BacktestUpAiInputs(BaseModel):
    identifier: str
...
class BacktestRequest(BaseModel):
    ...
    upai: Optional[BacktestUpAiInputs] = None
