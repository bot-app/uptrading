...
from uptrading.configuration import running_in_docker
...
from uptrading.rpc.api_server.ws.message_stream import MessageStream
from uptrading.rpc.rpc import RPC, RPCException, RPCHandler
...
class ApiServer(RPCHandler):
    ...
    def __init__(self, config: Config, standalone: bool = False) -> None:
        ...
        self.app = FastAPI(title="Uptrading API",
    ...
    def configure_app(self, app: FastAPI, config):
        from uptrading.rpc.api_server.api_auth import http_basic_or_jwt_token, router_login
        from uptrading.rpc.api_server.api_background_tasks import router as api_bg_tasks
        from uptrading.rpc.api_server.api_backtest import router as api_backtest
        from uptrading.rpc.api_server.api_v1 import router as api_v1
        from uptrading.rpc.api_server.api_v1 import router_public as api_v1_public
        from uptrading.rpc.api_server.api_ws import router as ws_router
        from uptrading.rpc.api_server.deps import is_webserver_mode
        from uptrading.rpc.api_server.web_ui import router_ui
