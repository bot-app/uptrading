...
from uptrading.enums import NO_ECHO_MESSAGES, RPCMessageType
from uptrading.rpc import RPC, RPCHandler
...
class RPCManager:
    ...
    def __init__(self, uptrading) -> None:
        ...
        self._rpc = RPC(uptrading)
        config = uptrading.config
        # Enable telegram
        if config.get('telegram', {}).get('enabled', False):
            logger.info('Enabling rpc.telegram ...')
            from uptrading.rpc.telegram import Telegram
