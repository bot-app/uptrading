...
from uptrading.constants import (USER_DATA_FILES, USERPATH_UPAIMODELS, USERPATH_HYPEROPTS,
...
def create_userdata_dir(directory: str, create_dir: bool = False) -> Path:
    ...
    sub_dirs = ["backtest_results", "data", USERPATH_HYPEROPTS, "hyperopt_results", "logs",
                USERPATH_NOTEBOOKS, "plot", USERPATH_STRATEGIES, USERPATH_UPAIMODELS]
    ...
    if not folder.is_dir():
        if create_dir:
            ...
            raise OperationalException(
                ...
                "Please use `uptrading create-userdir` to create a user directory")
