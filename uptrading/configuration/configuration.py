...
from uptrading.configuration.deprecated_settings import process_temporary_deprecated_settings
from uptrading.configuration.directory_operations import create_datadir, create_userdata_dir
from uptrading.configuration.environment_vars import enironment_vars_to_dict
from uptrading.configuration.load_config import load_file, load_from_files
from uptrading.constants import Config
from uptrading.enums import NON_UTIL_MODES, TRADING_MODES, CandleType, RunMode, TradingMode
from uptrading.exceptions import OperationalException
from uptrading.loggers import setup_logging
from uptrading.misc import deep_merge_dicts, parse_db_uri_for_logging
...
class Configuration:
    ...
    def load_config(self) -> Dict[str, Any]:
        ...
        self._process_upai_options(config)

        # Import check_exchange here to avoid import cycle problems
        from uptrading.exchange.check_exchange import check_exchange
    ...
    def _process_optimize_options(self, config: Config) -> None:
        ...
        self._args_to_config(config, argname='upai_backtest_live_models',
                             logstring='Parameter --upai-backtest-live-models detected ...')
    ...
    def _process_upai_options(self, config: Config) -> None:

        self._args_to_config(config, argname='upaimodel',
                             logstring='Using upaimodel class name: {}')

        self._args_to_config(config, argname='upaimodel_path',
                             logstring='Using upaimodel path: {}')
