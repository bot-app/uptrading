...
from uptrading.configuration.load_config import CONFIG_PARSE_MODE
...
from uptrading.plugins.pairlist.IPairList import IPairList, PairlistParameter
...
class RemotePairList(IPairList):
    ...
    def fetch_pairlist(self) -> Tuple[List[str], float]:
        ...
        headers = {
            'User-Agent': 'Uptrading/' + __version__ + ' Remotepairlist'
        }
