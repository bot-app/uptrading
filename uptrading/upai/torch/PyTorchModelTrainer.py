...
from uptrading.upai.torch.PyTorchDataConvertor import PyTorchDataConvertor
from uptrading.upai.torch.PyTorchTrainerInterface import PyTorchTrainerInterface
...
class PyTorchModelTrainer(PyTorchTrainerInterface):
    ...
    def fit(self, data_dictionary: Dict[str, pd.DataFrame], splits: List[str]):
        ...
        optional "test" could be added by setting upai.data_split_parameters.test_size > 0
        in the config file.
    ...
    def load_from_checkpoint(self, checkpoint: Dict):
        ...
        you can access this dict from any class that inherits IUpaiModel by calling
