...
from uptrading.upai.base_models.BaseClassifierModel import BaseClassifierModel
from uptrading.upai.base_models.UpaiMultiOutputClassifier import UpaiMultiOutputClassifier
...
class CatboostClassifierMultiTarget(BaseClassifierModel):
    ...
    def fit(self, data_dictionary: Dict, dk: UpaiDataKitchen, **kwargs) -> Any:
        ...
        model = UpaiMultiOutputClassifier(estimator=cbc)
