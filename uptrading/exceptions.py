class UptradingException(Exception):
    """
    Uptrading base exception. Handled at the outermost level.
    All other exception types are subclasses of this exception type.
    """


class OperationalException(UptradingException):
    """
...
class DependencyException(UptradingException):
    """
...
class StrategyError(UptradingException):
    """
