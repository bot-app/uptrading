...
from uptrading.constants import BACKTEST_BREAKDOWNS, DATETIME_PRINT_FORMAT, LAST_BT_RESULT_FN
from uptrading.data import history
from uptrading.data.btanalysis import (get_latest_backtest_filename, load_backtest_data,
                                       load_backtest_stats)
from uptrading.edge import PairInfo
from uptrading.enums import ExitType
from uptrading.optimize.optimize_reports import (generate_backtest_stats, generate_daily_stats,
...
from uptrading.optimize.optimize_reports.optimize_reports import (_get_resample_from_period,
                                                                  calc_streak)
from uptrading.resolvers.strategy_resolver import StrategyResolver
from uptrading.util import dt_ts
from uptrading.util.datetime_helpers import dt_from_ts, dt_utc
...
def test_store_backtest_stats(testdatadir, mocker):
    ...
    dump_mock = mocker.patch('uptrading.optimize.optimize_reports.bt_storage.file_dump_json')
...
def test_store_backtest_candles(testdatadir, mocker):
    ...
    dump_mock = mocker.patch(
        'uptrading.optimize.optimize_reports.bt_storage.file_dump_joblib')
