...
from uptrading.constants import FTHYPT_FILEVERSION
from uptrading.exceptions import OperationalException
from uptrading.optimize.hyperopt_tools import HyperoptTools, hyperopt_serializer
...
def test_try_export_params(default_conf, tmpdir, caplog, mocker):
    ...
    export_mock = mocker.patch("uptrading.optimize.hyperopt_tools.HyperoptTools.export_params")
