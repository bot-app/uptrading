...
def test_fiat_convert_find_price(mocker):
    ...
    mocker.patch('uptrading.rpc.fiat_convert.CryptoToFiatConverter._load_cryptomap',
                 return_value=None)
...
def test_fiat_convert_unsupported_crypto(mocker, caplog):
    mocker.patch('uptrading.rpc.fiat_convert.CryptoToFiatConverter._coinlistings', return_value=[])
    fiat_convert = CryptoToFiatConverter()
...
def test_fiat_convert_get_price(mocker):
    find_price = mocker.patch('uptrading.rpc.fiat_convert.CryptoToFiatConverter._find_price',
...
def test_convert_amount(mocker):
    mocker.patch('uptrading.rpc.fiat_convert.CryptoToFiatConverter.get_price', return_value=12345.0)
