...
Should not import anything from uptrading,
...
class FtRestClient:
    ...
    def pair_history(self, pair, timeframe, strategy, timerange=None, upaimodel=None):
        """Return historic, analyzed dataframe

        :param pair: Pair to get data for
        :param timeframe: Only pairs with this timeframe available.
        :param strategy: Strategy to analyze and get values for
        :param upaimodel: UpAi model to use for analysis
